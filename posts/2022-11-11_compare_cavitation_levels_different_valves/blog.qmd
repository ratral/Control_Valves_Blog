...
$F_d$ Valve style modifier. These values are travel-related and should be stated by the manufacturer \[ANSI/ISA-75.01.01-2007 (60534-2-1 Mod) : Annex A(informative) --- Derivation of valve style modifier\* $F_d$ Table 2 --- Typical values of valve style modifier $F_d = 0.41$, liquid pressure recovery factor $F_L$, and pressure differential ratio factor $x_T$ at full rated travel\]
